...
# python -u train_ts2vecar.py PenDigits default_ar_1 --loader UEA --max-threads 8 --seed 42 --share 0.0 --eval
...
# python -u train_ts2vecar.py PenDigits default_ar_2 --loader UEA --max-threads 8 --seed 42 --share 0.1 --eval
...
python -u train_ts2vecar.py PenDigits default_ar_3 --loader UEA --max-threads 8 --seed 42 --share 0.2 --eval
